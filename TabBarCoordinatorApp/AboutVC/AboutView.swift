...
class AboutView: UIView {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.useAndActivateConstraints(constraints: [
            ...
            descriptionBackgroundView.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 50),
            ...
            descriptionBackgroundView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -150),
